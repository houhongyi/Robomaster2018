...
#define Lift_First_Limite 250 //一级抬升极限
#define Lift_Second_Limite 280 //二级抬升极限
...
#define Motor_output_limit_UD 6000

#define Loction_pid_Ilimit 100

#define MOTOR_STRUCT_Lead 4.014//导程，就是无刷转一圈，执行机构走了多少 /3。14
